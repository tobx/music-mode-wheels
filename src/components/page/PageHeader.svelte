<header>
  ...
  <div class="center">
    ...
    <span>Check if your device is silenced.</span>
  </div>
  <div class="flex-1" />
</header>
...
<style>
  header {
    ...
    border-bottom: calc(1em / 16) solid var(--gray-200);
    display: flex;
    padding: 1em;
  }
